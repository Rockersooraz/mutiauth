...
<div class="container">
    ...
    @include('multiauth::message')
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group{{ $errors->has('Company Name') ? ' has-error' : '' }} row">
                            <label for="Company Name" class="col-md-4 col-form-label text-md-right">Company Name</label>

                            <div class="col-md-6">
                                <input id="Company Name" type="Company Name" class="form-control{{ $errors->has('Company Name') ? ' is-invalid' : '' }}" name="Company Name" value="{{ old('Company Name') }}"
                                    required>
                            </div>
                        </div>
