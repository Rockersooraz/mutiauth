                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="company_name" type="text" class="form-control{{ $errors->has('company_name') ? ' is-invalid' : '' }}" company_name="company_name" value="{{ old('company_name') }}" required autofocus>
